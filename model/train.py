...
df = df.drop(['Date', 'Rainfall', 'Location', 'Evaporation', 'Sunshine', 'WindGustDir', 'WindGustSpeed',
             'WindDir3pm', 'WindSpeed9am', 'WindSpeed3pm', 'WindDir9am', 'Cloud9am', 'Cloud3pm', 'RainTomorrow'], axis=1)
